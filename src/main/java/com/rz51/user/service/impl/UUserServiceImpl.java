package com.rz51.user.service.impl;
...
import com.rz51.common.model.UUserRole;
...
import com.rz51.core.shiro.session.CustomSessionManager;
...
@Service
public class UUserServiceImpl extends BaseMybatisMapper<UUserMapper> implements UUserService {
    /***
     * 用户手动操作Session
     * */
    @Autowired
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Pagination<UserRoleAllocationExt> findUserAndRole(ModelMap modelMap,
                                                             Integer pageNo, Integer pageSize) {
    ...
    @Override
    public UUser findUserByClientId(String clientId) {
        return userMapper.findUserByClientId(clientId);
    }
