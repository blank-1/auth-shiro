...
import com.rz51.core.mybatis.page.MysqlDialect;
import com.rz51.core.mybatis.page.Pagination;

public class BaseMybatisMapper<T> extends SqlSessionDaoSupport {

	private String NAMESPACE;
	final static  Class<? extends Object> SELF = BaseMybatisMapper.class;
	protected final Log logger = LogFactory.getLog(BaseMybatisMapper.class);
	/**默认的查询Sql id*/
	final static String DEFAULT_SQL_ID = "findAll";
	/**默认的查询Count sql id**/
	final static String DEFAULT_COUNT_SQL_ID = "findCount";
	public BaseMybatisMapper() {
		try {
