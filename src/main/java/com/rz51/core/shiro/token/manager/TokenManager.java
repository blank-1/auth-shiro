package com.rz51.core.shiro.token.manager;

import java.util.List;

import com.rz51.core.shiro.token.AuthRealm;
import org.apache.shiro.SecurityUtils;
import org.apache.shiro.session.Session;
import org.apache.shiro.subject.SimplePrincipalCollection;

import com.rz51.common.model.UUser;
import com.rz51.common.utils.SpringContextUtil;
import com.rz51.core.shiro.session.CustomSessionManager;
import com.rz51.core.shiro.token.ShiroToken;
...
public class TokenManager {
	//用户登录管理
	public static final AuthRealm realm = SpringContextUtil.getBean("sampleRealm",AuthRealm.class);
	//用户session管理
