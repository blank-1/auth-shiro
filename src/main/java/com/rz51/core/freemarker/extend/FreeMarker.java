package com.rz51.core.freemarker.extend;
...
import com.rz51.common.utils.UtilPath;
import com.rz51.core.tags.APITemplateModel;
...
//		initMap.put("path", path);
		...
		FreeMarkerConfigExt ext = SpringContextUtil.getBean("freemarkerConfig",FreeMarkerConfigExt.class);
		...
		try {
			FreeMarkerConfigExt.putInitShared(cfg);
