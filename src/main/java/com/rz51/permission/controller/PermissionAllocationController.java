...
public class PermissionAllocationController extends BaseController {
	...
	public ModelAndView allocation(ModelMap modelMap,Integer pageNo,String findContent){
		...
		Pagination<RolePermissionAllocationExt> boPage = roleService.findRoleAndPermissionPage(modelMap,pageNo,pageSize);
	...
	public List<UPermissionExt> selectPermissionById(Long id){
		List<UPermissionExt> permissionBos = permissionService.selectPermissionById(id);
