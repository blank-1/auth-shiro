package com.rz51.permission.service.impl;
...
import com.rz51.common.dao.UPermissionMapper;
import com.rz51.common.dao.URolePermissionMapper;
import com.rz51.common.dao.UUserMapper;
import com.rz51.common.dao.UUserRoleMapper;
import com.rz51.common.model.URolePermission;
import com.rz51.common.utils.LoggerUtils;
import com.rz51.common.utils.StringUtils;
import com.rz51.core.mybatis.BaseMybatisMapper;
import com.rz51.core.mybatis.page.Pagination;
import com.rz51.core.shiro.token.manager.TokenManager;
import com.rz51.permission.enti.UPermissionExt;
import com.rz51.permission.service.PermissionService;
@Service
public class PermissionServiceImpl extends BaseMybatisMapper<UPermissionMapper> implements PermissionService {
	...
	@Override
	public com.rz51.common.model.UPermission insert(com.rz51.common.model.UPermission record) {
		permissionMapper.insert(record);
		return record;
	}

	@Override
	public com.rz51.common.model.UPermission insertSelective(com.rz51.common.model.UPermission record) {
		//添加权限
	...
	@Override
	public com.rz51.common.model.UPermission selectByPrimaryKey(Long id) {
		return permissionMapper.selectByPrimaryKey(id);
	}

	@Override
	public int updateByPrimaryKey(com.rz51.common.model.UPermission record) {
		return permissionMapper.updateByPrimaryKey(record);
	}

	@Override
	public int updateByPrimaryKeySelective(com.rz51.common.model.UPermission record) {
	...
	@Override
	public Pagination<com.rz51.common.model.UPermission> findPage(Map<String,Object> resultMap, Integer pageNo,
																  Integer pageSize) {
		return super.findPage(resultMap, pageNo, pageSize);
	}

	@Override
	public List<UPermissionExt> selectPermissionById(Long id) {
